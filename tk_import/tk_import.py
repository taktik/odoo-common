...
class import_template(osv.osv):
    ...
    _columns = {
            ...
            'model_id':         fields.related('import_model_id','model_id', type='many2one', obj='ir.model',string='Model'),
...
class import_file(osv.osv):
    ...
    __states = [('processed','Processed'),('error','Error'),('processing','Processing'), ('header','Header Checked')]
    ...
    _columns = {
            ...
            'error_report':         fields.function(__get_error_report, type='binary', method=True, string='Error Report'),
...
class export_file(osv.osv):
    ...
    _columns = {
            ...
            'model_id':             fields.related('import_model_id','model_id', type='many2one', obj='ir.model', string='Model'),
            'file':                 fields.function(__get_export, type='binary', method=True, string='File'),
...
class import_model2(osv.osv):
    ...
    _columns = {
            'import_ids':   fields.one2many('tk_import.file', 'import_model_id', 'Imports'),
            'template_ids': fields.one2many('tk_import.template', 'import_model_id', 'Templates'),
            'export_ids':   fields.one2many('tk_import.export_file', 'import_model_id', 'Exports'),
                }
