...
class tk_import_wizard_export_sample(osv.osv_memory):
    ...
    _columns = {
            ...
            'model_id':         fields.many2one('ir.model', 'Model'),
            'column_ids':       fields.many2many('tk_import.column', 'tk_import_column_to_wizard', 'wizard_id', 'column_id', 'Columns'),
            'key_ids':          fields.many2many('tk_import.column', 'tk_import_key_to_wizard', 'wizard2_id', 'key_id', 'Columns'),
    ...
    def generate_in_memory_columns(self, cr, uid, id, columns, model_id, context, parent_column=''):
        ...
        for column_name in columns.keys():
            ...
            existing_columns = column_obj.search(cr, uid, [('name','=',column_name),('model_id','=',model_id),('wizard_id','=',id)])
