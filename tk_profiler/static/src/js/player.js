openerp.tk_profiler = function (instance) {

    instance.web.ProfilerPlayerWidget = instance.web.Widget.extend({
        template: 'tk_profiler.player',
        events: {
            ...
            this.update_promise.done(function () {
                self.rpc('/web/profiler/initial_state', {}).done(function (state) {
                    if (state.has_player_group) {
                        this.profiler_player = new instance.web.ProfilerPlayerWidget(this);
